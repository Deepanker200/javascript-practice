...
console.log(arr5.slice(-2,-5));     //slice(start, end) only works if start < end (in terms of index).
// console.log(arr5.slice(-5,-2));     
//IMP: Negative deleteCount is ignored in Splice
